...
REGIME_BREADTH_CONTINUATION_MIN = min(max(_env_float("REGIME_BREADTH_CONTINUATION_MIN", 0.45), 0.0), 1.0)
REGIME_BREADTH_WARNING_MIN = min(max(_env_float("REGIME_BREADTH_WARNING_MIN", 0.25), 0.0), 1.0)
REGIME_BREADTH_RISK_OFF_MAX = min(max(_env_float("REGIME_BREADTH_RISK_OFF_MAX", 0.15), 0.0), 1.0)
REGIME_BREADTH_STRONG_BTC_OVERRIDE_MIN = min(max(_env_float("REGIME_BREADTH_STRONG_BTC_OVERRIDE_MIN", 0.33), 0.0), 1.0)
...
REGIME_BTC_BELOW_SLOW_SOFT_PCT = min(max(abs(_env_float("REGIME_BTC_BELOW_SLOW_SOFT_PCT", 0.0035)), 0.0), 0.05)
REGIME_BTC_BELOW_SLOW_HARD_PCT = min(max(abs(_env_float("REGIME_BTC_BELOW_SLOW_HARD_PCT", 0.0125)), 0.0), 0.10)
REGIME_BTC_CONTEXT_SCORE_CONTINUATION_MIN = max(min(_env_int("REGIME_BTC_CONTEXT_SCORE_CONTINUATION_MIN", 4), 5), 1)
REGIME_BTC_CONTEXT_SCORE_RECOVERY_MIN = max(min(_env_int("REGIME_BTC_CONTEXT_SCORE_RECOVERY_MIN", 3), 5), 1)
